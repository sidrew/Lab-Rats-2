...
label small_talk_person(the_person, apply_energy_cost = True): #Tier 0. Useful for discovering a character's opinions and the first step to building up love.
    ...
    if ran_num < successful_smalltalk:
        ...
        if not opinion_learned is None:
            ...
            if opinion_state[1]:
                "You listen while [the_person.possessive_title!l] talks about how she [opinion_string] [opinion_learned]."
            else:
                $ the_person.discover_opinion(opinion_learned)
                "You listen while [the_person.possessive_title!l] talks and discover that she [opinion_string] [opinion_learned]."

            $ the_person.change_love(love_gain - prediction_difference, max_modified_to = 20)

        else:
            "You and [the_person.possessive_title!l] chat for a while. You don't feel like you've learned much about her, but you both enjoyed talking."
