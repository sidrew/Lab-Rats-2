...
label movie_date_label(the_person):
    ...
    menu:
        ...
        "Get ready for the date\n{color=#ff0000}{size=18}Requires: $50{/size}{/color} (disabled)" if not mc.business.has_funds(50):
            pass
...
label dinner_date_label(the_person):
    ...
    menu:
        ...
        "Get ready for the date\n{color=#ff0000}{size=18}Requires: $30{/size}{/color} (disabled)" if not mc.business.has_funds(50):
            pass
...
label shopping_date_overwear(the_person, skip_intro = False):
    ...
    if _return:
        ...
        menu:
            "Pay for the outfit\n{color=#ff0000}{size=18}Costs: $[cost]{/size}{/color}" if mc.business.has_funds(cost):
    ...
    menu:
        ...
        "Pull out your cock" if the_person.effective_sluttiness() >= 30:
            ...
            menu:
                ...
                "Ask for a blowjob\n{color=#ff0000}{size=18}Requires: [blowjob_slut_token]{/size}{/color} (disabled)" if the_person.effective_sluttiness() < blowjob_slut_requirement:
