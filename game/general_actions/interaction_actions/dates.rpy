...
label shopping_date_food(the_person):
    ...
    menu:
        "Pay for her lunch\n{color=#ff0000}{size=18}Costs: $40{/size}{/color}" if mc.business.funds >= 40:
        ...
        "Pay for her lunch\n{color=#ff0000}{size=18}Costs: $40{/size}{/color} (disabled)" if mc.business.funds < 40:
            pass
...
label shopping_date_overwear(the_person, skip_intro = False):
    ...
    if _return:
        ...
        menu:
            "Pay for the outfit\n{color=#ff0000}{size=18}Costs: $[cost]{/size}{/color}" if mc.business.funds >= cost:
