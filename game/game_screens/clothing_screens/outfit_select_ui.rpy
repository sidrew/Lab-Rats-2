            ...
            if category_info[0]:
                frame:
                    ...
                    viewport:
                        ...
                        vbox:
                            spacing -10
                            text category_info[1] + "s" style "menu_text_style" size 30 #Add an s to make it plural so we can reuse the field in the new button. Yep, I'm that clever-lazy.
                            null height 10
                            if show_make_new:
                            ...
                            for outfit in category_info[6](mc.designed_wardrobe):
                                textbutton outfit.name + " (Sluttiness " +str(category_info[3](outfit)) +")":
