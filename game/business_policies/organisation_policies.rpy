init 0 python:
    ...
    attention_bleed_increase_1_policy = Policy(name = "Public Charity Work",
        desc = "Sponsor a few local charities to improve the public perception of your business. Reduces pressure for authorities to take action against you, lowering Attention by an additional 10 per day.",
        cost = 2000,
        toggleable = False,
