...
#upright_doggy positions are taken as 700x1080 images with 675 offset
    ...
    python:
        ...
        evening_dress = Clothing("Evening dress", 2, True, True, "Evening_Dress", True, False, 4, has_extension = evening_dress_bottom, whiteness_adjustment = 0.4, display_name = "dress",
            constrain_regions = [torso_region, stomach_region, skirt_region])
        ...
        lacy_one_piece_underwear = Clothing("Lacey One Piece", 1, True, True, "Lacy_One_Piece_Underwear", True, True, 4, tucked = True, has_extension = lacy_one_piece_underwear_bottom, whiteness_adjustment = 0.2, display_name = "underwear")
        ...
        bodysuit_underwear_bottom = Clothing("Bodysuit lace", 1, True, True, "Bodysuit_Underwear", False, True, 0, is_extension = True)
