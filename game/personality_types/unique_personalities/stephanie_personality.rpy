...
label stephanie_improved_serum_unlock(the_person):
    ...
    the_person "Our data did indicate that, yes. [nora.name]'s hypothesis was that an orgasm opened up chemical receptors that were normally unavailable."
    ...
    the_person "Come on [the_person.mc_title], this is the stuff [nora.name] would never let me do! It's a chance to be at the bleeding edge of science!"
