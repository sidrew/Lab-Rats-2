            ...
            menu:
                "Insult her":
                    ...
                    if the_person.obedience < (90 - (15*the_person.get_opinion_score("being submissive"))):
                        ...
                        the_person.char "Do I deserve to be here? I... I can't believe you!"
                        the_person.char "I come in every day and work my hardest, and this is the thanks I get?"
                        ...
                        the_person.char "Discipline this!"
                ...
                "Let her go":
                    ...
                    the_person.char "Yes [the_person.mc_title], I understand."
...
label punishment_wrist_slap(the_person, the_infraction):
    ...
    if the_person.obedience < (120 - (15*the_person.get_opinion_score("being submissive"))):
        ...
        the_person.char "Ow, that stings..."
    else:
    ...
    the_person.char "I'm sorry [the_person.mc_title], it won't happen again."
    menu:
        "Keep going":
            ...
            if the_person.obedience < (120 - (15*the_person.get_opinion_score("being submissive"))):
                the_person.char "Ach... How many times do you need to do this, exactly?"
            ...
            the_person.char "Yes [the_person.mc_title], I have."
        ...
        "Let her go":
            ...
            if the_person.get_opinion_score("being submissive") > 0:
                the_person.char "If you need to be rough with me I understand. Sometimes I deserve it."
...
label punishment_serum_test(the_person, the_infraction):
    ...
    the_person.char "Alright, hand it over."
        ...
        menu:
            "Make her pay for it" if mandatory_unpaid_serum_testing_policy.is_active():
                ...
                if the_person.obedience >= 130:
                    ...
                    the_person.char "What? But this was your idea, why do I need to pay?"
                    ...
                    "She sighs."
                    the_person.char "This should be illegal. Fine."
                    $ the_person.change_obedience(1)
        ...
        menu:
            "Pull up her [top_clothing.display_name] first":
                if the_person.obedience + 10*the_person.get_opinion_score("being submissive") < 120 and the_person.effective_sluttiness("underwear_nudity") < 30:
                    ...
                    the_person.char "Are... Are you allowed to do that?"
...
label spank_description(the_person, the_infraction):
    ...
    if not_cushioned: #ouch!
        ...
        the_person.char "Ah... That really stings..."
    else: #Not too bad.
    ...
    menu:
        "Go easy on her":
            ...
            if the_person.get_opinion_score("being submissive") > 0:
                the_person.char "Is that all? I thought this would go on longer..."
        ...
        "Teach her a lesson":
            ...
            if not_cushioned: #Ass gets red, she gets sore.
                ...
                if the_person.get_opinion_score("being submissive") > 0: #She likes it and is getting turned on.
                    ...
                    the_person.char "I... Don't know if I can take much more of this! Mmph..."

                else:
                    "You spank her again, making her gasp."
                    the_person.char "I... Don't know how much more of this I can take!"

                mc.name "You'll take it until I think you have learned your lesson. Do you understand?"
                "Another smack, another ass jiggle."
                if the_person.get_opinion_score("being submissive") > 0:
                    the_person.char "Yes [the_person.mc_title]! I understand! Ah!"
                else:
                    "She lowers her head and grits her teeth."

                    the_person.char "Yes [the_person.mc_title]. Ah..."

                mc.name "Do you have anything to say for your actions?"
                if the_person.get_opinion_score("being submissive") > 0:
                    the_person.char "It won't happen again [the_person.mc_title], I..."
                    "You interrupt her with a slap on the ass. She pauses, then continues."
                    the_person.char "I'm sorry to let you down, and I see just how wrong I was now! Ah!"

                else:
                    the_person.char "Ow... It won't happen again [the_person.mc_title], I... Ow!"
                    "You interrupt her with a slap on the ass. She takes a moment to collect herself before continuing."
                    the_person.char "I promise it won't happen again!"
                ...
                if the_person.get_opinion_score("being submissive") > 0:
                    ...
                    the_person.char "Thank you [the_person.mc_title]. I promise I'll do better."
                else:
                    $ the_person.change_obedience(3)
                    $ the_person.change_love(-2 + the_person.get_opinion_score("being submissive"))
                    the_person.char "Finally. Ow..."
                ...
                the_person.char "I'll get back to work..."
                $ the_person.change_love(-1)
                $ the_person.change_obedience(2)
    return
...
label punishment_underwear_only(the_person, the_infraction):
    ...
    if not (the_person.outfit.wearing_bra() and the_person.outfit.wearing_panties()): # Whoops, not wearing underwear today! Tough luck.
        ...
        if not (the_person.outfit.wearing_bra() or the_person.outfit.wearing_panties()):
            the_person.char "No, I mean I can't strip down to my underwear because... I'm not wearing any."
            ...
            the_person.char "No, I mean I can't strip down to my underwear because... I'm not wearing a bra."
            the_person.char "My... breasts would be out."
            $ slut_continue_requirement += -(5*the_person.get_opinion_score("showing her tits"))

        else: #not wearing panties
            the_person.char "No, I mean I can't strip down to my underwear because... I'm not wearing any panties."
        ...
        the_person.char "So you still want me to..."
        mc.name "Strip. Now."
        ...
        if the_person.effective_sluttiness() < slut_continue_requirement:
            ...
            the_person.char "I don't think I can do it. I'm sorry [the_person.mc_title]."
            ...
            $ the_person.change_obedience(-1)
            the_person.char "I'm sorry, but I just can't do it. I'll accept a worse punishment if I have to."
            $ the_person.add_infraction(Infraction.disobedience_factory())
        ...
        if the_person.effective_sluttiness("underwear_nudity") < 40:
            $ the_person.draw_person(emotion = "angry")
            the_person.char "You... You can't make me do that!"
            if reduced_coverage_uniform_policy.is_active():
            ...
            the_person.char "Okay, I understand."
    else:
        if the_person.effective_sluttiness("underwear_nudity") < 40:
            # Obedient but very shy about it
            "She blushes and looks away."
            the_person.char "Are you sure [the_person.mc_title]? I'm not use to... being undressed in front of people."
            mc.name "Of course I'm sure. Now strip."
            "She nods meekly."
            the_person.char "Okay, if you say I have to..."

        else:
            # Obedient and slutty, the perfect combination
            "[the_person.title] nods obediently."
            the_person.char "Yes [the_person.mc_title], I'll go change into my new uniform."
            mc.name "You'll change right here. Now strip."
            the_person.char "Of course. Right away."
    ...
    if the_person.update_outfit_taboos() or the_person.effective_sluttiness() < 40:
        ...
        the_person.char "This is so embarrassing..."
    $ slut_change = 0
    ...
    menu:
        ...
        "Moderate cut\n{color=#00ff00}{size=18}Profit: $[mod_amount] / day{/size}{/color}":
            ...
            if the_person.obedience + 10*the_person.get_opinion_score("being submissive") < 125:
                ...
                the_person.char "Of course. Thank you [the_person.mc_title], for being so understanding."
            else:
                the_person.char "I... Is there anything else I can do to make it up? That's a big cut."
        ...
        "Major cut\n{color=#00ff00}{size=18}Profit: $[maj_amount] / day{/size}{/color}":
            ...
            if the_person.obedience + 10*the_person.get_opinion_score("being submissive") < 125:
                ...
                the_person.char "I... I understand. I'm sorry for letting you down like this [the_person.mc_title]..."
                ...
                the_person.char "Are you sure? That seems like a very big change."
                ...
                "She shakes her head."
                the_person.char "No, I don't want to do that. I... I understand."
...
label strip_naked_command_helper(the_person, the_infraction): #Helper function for events that need a girl to strip naked.
    ...
    if the_person.obedience + 10*the_person.get_opinion_score("being submissive") < 125 and the_person.effective_sluttiness(["bare_tits", "bare_pussy"]) < 60:
        ...
        the_person.char "Isn't there something else I could do? Do you really need me to be naked?"
...
label punishment_office_humiliating_work(the_person, the_infraction):
    ...
    if the_person.int >= 3 and the_person.obedience + 10*the_person.get_opinion_score("being submissive") < 120: #She went to university, she doesn't want to scrub toilets!
        the_person.char "You... expect me to clean up after everyone in here?"
        mc.name "I do. I expect you to be scrubbing scrubbing toilets, washing floors, and taking out the garbage."
        the_person.char "I have a degree! This is just a complete waste of my time!"
        ...
        the_person.char "I don't know how you can expect that [the_person.mc_title], there aren't enough hours in the day!"
...
label punishment_orgasm_denial(the_person, the_infraction):
    ...
    if the_person.effective_sluttiness() < 40:
        the_person.char "You can't... You aren't allowed to do that, are you?"
        ...
        the_person.char "I'll take my punishment, [the_person.mc_title]... I doubt you'll even get me close."
        mc.name "Good girl. I won't make you wait any longer..."
    elif the_person.effective_sluttiness() < 80:
        the_person.char "Okay [the_person.mc_title], I'll take my punishment."
        "You slide your hand from her hip down to her inner thigh."
        mc.name "Good girl."
    else:

        the_person.char "You wouldn't be that cruel, would you [the_person.mc_title]?"
        the_person.char "Come on, wouldn't it be better if we both enjoyed ourselves?"
    ...
    if the_report.get("girl orgasms", 0) == 0: #Successfully didn't let her orgasm.
        if the_report.get("end arousal", 0) >= 95 : # Got her very close
            ...
            if the_person.wants_creampie():
                the_person.char "Please, just fuck me and make me cum! You can cum inside of me, I don't care!"
                the_person.char "I need it!"
                ...
                menu:
                    "Fuck her":
                        ...
                        if the_report.get("girl orgasms", 0) > 0:
                            ...
                            the_person.char "No, no, no, you can't... Not again!"
                            mc.name "Sorry [the_person.title], but you need to learn your lesson."
                            the_person.char "Fuck... I'm so horny, I can't think straight!"
            ...
            the_person.char "So, are we done?"
        ...
        the_person.char "Ah, that was nice..."
...
label punishment_forced_punishment_outfit(the_person, the_infraction):
    ...
    if not (the_person.outfit.tits_available() and the_person.outfit.vagina_available() and the_person.outfit.tits_visible() and the_person.outfit.vagina_available()): #Something to strip
        ...
        if the_person.update_outfit_taboos(): # Broke a taboo
            ...
            mc.name "Hands down, there's no point hiding anything from me now."
            "She frowns, but follows your instructions. She lowers her hands to her sides, letting you get a good view of her body."
        the_person.char "What now, [the_person.mc_title]?"
    else:
    ...
    if the_outfit is None:
        ...
        if the_person.effective_sluttiness() < the_person.outfit.slut_requirement:
            the_person.char "Is this it? This is so embarrassing..."
...
init -1 python:
    ...
    def add_freeuse_role_and_clear_punishment_action(person):
        person.add_role(employee_freeuse_role)
        clear_action = Action("Clear employee freeuse", employee_freeuse_remove_requirement, "employee_freeuse_remove_label", args = person, requirement_args = [person, day + 7])
        mc.business.mandatory_crises_list.append(clear_action)
        return
...
label punishment_unpaid_intern(the_person, the_infraction):
    ...
    if the_person.obedience < 150:
        ...
        the_person.char "You can't do that, how am I going to live?"
        ...
        the_person.char "That's blackmail, there's no way this is legal."
        ...
        the_person.char "Right, I understand. Do you need anything else?"
        mc.name "You're taking this well..."
        the_person.char "You've made your decision, that's all I need to know [the_person.mc_title]."
        mc.name "Good, I'm glad to hear such dedication from you. Keep it up and I'm sure you'll earn a promotion."
        the_person.char "Thank you [the_person.mc_title], I'll try."
...
label punishment_office_freeuse_slut(the_person, the_infraction):
    ...
    if the_person.effective_sluttiness() + (10*the_person.get_opinion_score("being submissive")) < 40: #Not very slutty, needs it explained
        if the_person.obedience < 140: # Not obedient enough to let it happen without complaining.
            the_person.char "I don't understand, what does that even mean? I already have to show up to work, what else can I do?"
            ...
            the_person.char "[the_person.mc_title]! I can't... You don't really expect me to just take this, do you?"
            ...
            the_person.char "Just for a week... Fine."

        else: # Not slutty, but obedient enough to let it happen. Nun style answers
            the_person.char "I can show up for work earlier, if that's what you mean."
            ...
            if the_person.has_large_tits():
                ...
                "You reach out and grab at one of [the_person.title]'s tits."
            mc.name "These tits are what I'm interested in, along with the rest of you."
            the_person.char "Oh... I think I understand now."
        ...
        if the_person.obedience < 140:
            the_person.char "I think I can see where this is going. You want me to act all sexy around the office to keep you entertained."
            ...
            the_person.char "I understand [the_person.mc_title]. I will be yours to use, whenever you want me."
        ...
        if the_person.obedience < 140: # Eager slut answer
            the_person.char "You're going to fuck me, [the_person.mc_title]? All week long?"
            "She doesn't seem very upset by the idea."
            the_person.char "I understand, if that's my punishment I accept it."
        else: # Obedient fuck slut answer
            the_person.char "Yes [the_person.mc_title]. My holes are yours to fuck whenever you want."
            the_person.char "I'll be your fuck slut to make up for my mistakes, and I promise to do better."
