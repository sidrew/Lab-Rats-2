init -2:
    python:
        ...
        def get_possessive_titles(the_person):
            ...
            if the_person.sluttiness > 60:
                if the_person.int <= 1 and the_person.has_large_tits():
...
init 1 python:
    def generate_premade_list():
        ...
        person_lynn.set_opinion("cheating on men", -1, False)
        ...
        person_olga.set_opinion("working", 1, False)
