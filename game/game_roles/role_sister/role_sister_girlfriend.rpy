...
label sister_girlfriend_intro(the_person):
    ...
    if not the_person.event_triggers_dict.get("sister_girlfrind_asked_before", False):
    ...
    menu:
        ...
        "Order her to agree\n{color=#ff0000}{size=18}Requires: 200 Obedience{/size}{/color} (disabled)" if the_person.obedience < 200:
            pass
        ...
        "Think of the baby!\n{color=#ff0000}{size=18}Requires: Get her pregnant!{/size}{/color} (disabled)" if not the_person.event_triggers_dict.get("preg_your_kids_known",0) > 0 and persistent.pregnancy_pref > 0:
            pass
    ...
    menu:
        ...
        "Who cares what other people think?\n{color=#ff0000}{size=18}Requires: Positive incest opinion{/size}{/color} (disabled)" if the_person.get_known_opinion_score("incest") <= 0:
            pass
        ...
        "We'll keep it a secret\n{color=#ff0000}{size=18}Requires: Both 4+ Focus{/size}{/color} (disabled)" if mc.focus < 4 or the_person.focus < 4:
            pass
        ...
        "We'll pretend we aren't related\n{color=#ff0000}{size=18}Requires: Both 4+ Charisma{/size}{/color} (disabled)" if mc.charisma < 4 or the_person.charisma < 4:
            pass
    ...
    menu:
        ...
        "Don't worry, I'm dating her too" if mom.has_role(mom_girlfriend_role): #TODO: Requires: you're also already in a relationship with Mom.
            ...
            if the_person.event_triggers_dict.get("mom_girlfriend_sister_knows", False):
        ...
        "Don't worry, I'm dating her too\n{color=#ff0000}{size=18}Requires: Dating [mom.title]{/size}{/color} (disabled)" if not mom.has_role(mom_girlfriend_role): #TODO: Fill in with inverse requirement once we have the forward one.
            pass
        ...
        "She's too dumb to notice\n{color=#ff0000}{size=18}Requires: [mom.title] 1 Int{/size}{/color} (disabled)" if mom.int >= 2:
            pass
...
label sister_girlfriend_mom_blessing(the_person):
    ...
    menu:
        ...
        "Demand she allows it\n{color=#ff0000}{size=18}Requires: [the_person.title] 200 Obedience{/size}{/color} (disabled)" if the_person.obedience < 200:
            pass
    ...
    $ lily.event_triggers_dict["sister_girlfriend_mom_blessing_given"] = convinced
