...
label sister_vaginal_interrupt(the_person): #TODO: Figure out a way to hook this up.
...
label sister_vaginal_taboo_break_revisit_quest_1(the_person):
    ...
    $ (slutty_serum, happy_serum) = validate_sister_serum()
