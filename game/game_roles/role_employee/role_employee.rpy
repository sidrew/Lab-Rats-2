            ...
            if the_person.work_experience < 5 and day > the_person.event_triggers_dict.get("last_promotion_request", -1) + 10:
                ...
                if days_employed >= (the_person.work_experience*the_person.work_experience*4 + 10): #14 days, 26, 46, 74 days.
                    if renpy.random.randint(0,100) < 5 - the_person.work_experience: #ie. longer mean time between promotion requests by higher experience people
                        request_promotion_action = Action(the_person.name + " requests_promotion", quiting_crisis_requirement, "request_promotion_crisis_label", args = the_person, requirement_args = the_person)
...
label employee_pay_cash_bonus(the_person):
    ...
    menu:
        ...
        "Give her a days wages\n{color=#ff0000}{size=18}Costs: $[days_wages]{/size}{/color}" if mc.business.has_funds(days_wages):
        ...
        "Give her a weeks wages\n{color=#ff0000}{size=18}Costs: $[weeks_wages]{/size}{/color}" if mc.business.has_funds(weeks_wages):
        ...
        "Give her a months wages\n{color=#ff0000}{size=18}Costs: $[months_wages]{/size}{/color}" if mc.business.has_funds(months_wages):
                                ...
                                "Make her strip":
                                    ...
                                    if not (the_person.outfit.vagina_visible() and the_person.outfit.tits_visible()):
                                        menu:
                                            ...
                                            "Make her strip naked\n{color=#ff0000}{size=18}Requires: 110 Obedience{/size}{/color} (disabled)" if the_person.obedience < 110:
                                                pass
                                ...
                                "Fuck her"  if the_person.effective_sluttiness() >= 60:
                                    ...
                                    if the_person.wants_condom():
                                        ...
                                        menu:
                                            ...
                                            "Fuck her raw anyways\n{size=16}{color=#FF0000}Requires: 130 Obedience{/color}{/size} (disabled)" if the_person.obedience < 130:
                                                pass
                    ...
                    "Make her strip":
                        ...
                        if not (the_person.outfit.vagina_visible() and the_person.outfit.tits_visible()):
                            menu:
                                ...
                                "Make her strip naked\n{color=#ff0000}{size=18}Requires: 110 Obedience{/color}{/size} (disabled)" if the_person.obedience < 110:
                                    pass
