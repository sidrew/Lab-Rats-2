...
init -2 python:
    ...
    def build_instapic_comment_actions(person, posted_today):
        display_list = []
    ...
    def build_dm_description_actions(person):
        dm_option_specific_outfit_action = Action("Wear a specific outfit\n{color=#ff0000}{size=18}Costs: $20{/size}{/color}", dm_option_specific_outfit_requirement, "dm_option_specific_outfit", requirement_args = person)
        dm_option_underwear_action = Action("Show me your underwear\n{color=#ff0000}{size=18}Costs: $50{/size}{/color}", dm_option_underwear_requirement, "dm_option_underwear", requirement_args = person)
        dm_option_topless_action = Action("Show me your tits\n{color=#ff0000}{size=18}Costs: $100{/size}{/color}", dm_option_topless_requirement, "dm_option_topless", requirement_args = person)
        dm_option_nude_action = Action("Send me some nudes\n{color=#ff0000}{size=18}Costs: $200{/size}{/color}", dm_option_nude_requirement, "dm_option_nude", requirement_args = person)
    ...
    def add_dm_outfit_response(person, outfit):
        response_action = Action("DM outfit response", dm_response_requirement, "dm_option_specific_outfit_response", args = [person, outfit], requirement_args = person)
        mc.business.mandatory_crises_list.append(response_action)
        return

    def add_dm_underwear_response(person):
        response_action = Action("DM underwear response", dm_response_requirement, "dm_option_underwear_response", args = person, requirement_args = person)
        mc.business.mandatory_crises_list.append(response_action)
        return

    def add_dm_topless_response(person):
        response_action = Action("DM topless response", dm_response_requirement, "dm_option_topless_response", args = person, requirement_args = person)
        mc.business.mandatory_crises_list.append(response_action)
        return

    def add_dm_nude_response(person):
        response_action = Action("DM topless response", dm_response_requirement, "dm_option_nude_response", args = person, requirement_args = person)
        mc.business.mandatory_crises_list.append(response_action)
        return
