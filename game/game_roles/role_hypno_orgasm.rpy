...
label hypno_trigger_orgasm(the_person, use_intro = True):
    ...
    if the_person.arousal < 25:
        ...
        $ the_person.run_orgasm(trance_chance_modifier = the_person.get_opinion_score("being submissive")) #ie. positive opinions of being submissive make her more likely to trance off of this.
        $ the_person.reset_arousal()
        ...
        menu:
            ...
            "Let her fall":
                ...
                "When she realizes where she is she pulls herself up off of the floor, looking more than a little embarrassed."
                $ the_person.draw_person(emotion = "happy")
