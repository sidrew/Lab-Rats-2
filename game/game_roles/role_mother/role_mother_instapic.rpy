...
label mom_instapic_ban(the_person):
    ...
    menu:
        "Tell her about OnlyFanatics" if not the_person.event_triggers_dict.get("onlyfans_known", False):
            ...
            $ the_person.get_role_reference(mother_role).actions.append(Action("Help her with OnlyFanatics {image=gui/heart/Time_Advance.png}", mom_onlyfans_help_requirement, "mom_onlyfans_help", is_fast = False))
    ...
    menu:
        "Convince her to keep going" if the_person.effective_sluttiness() >= slut_requirement:
            ...
            menu:
                ...
                "Get your cock out\n{color=#ff0000}{size=18}Requires: [slut_token]{/size}{/color} (disabled)" if the_person.effective_sluttiness() < slut_requirement:
                    pass
