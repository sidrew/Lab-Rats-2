...
init -2 python:
    ...
    def onlyfans_on_day(the_person):
        ...
        nudes_weight = 25 + 10*(the_person.get_opinion_score(["showing her tits", "showing her ass"]))
        dildo_weight = 25 + 10*(the_person.get_opinion_score(["public sex", "masturbating"]))
