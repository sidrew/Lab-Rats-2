...
init -2 python:
    ...
    def remove_employee_freeuse_role(person):
        ...
        if person.has_role(employee_role):
            freeuse_report_action  = Action("Freeuse report crisis", employee_freeuse_report_requirement, "employee_freeuse_report_label", args = person, requirement_args = person)
