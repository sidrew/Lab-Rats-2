...
init -2 python:
    def employee_freeuse_remove_requirement(person, trigger_day):
        if day >= trigger_day:
            return True
        return False
...
label employee_freeuse_remove_label(the_person):
    $ remove_employee_freeuse_role(the_person)
    return
...
label employee_freeuse_report_label(the_person):
    ...
    if the_person.effective_sluttiness() > 80 and the_person.get_opinion_score("being submissive") + the_person.event_triggers_dict.get("freeuse orgasms", 0) > 3: #You have to make her cum, more is better depending on her opinion.
        the_person.char "I have, and I know what I want now [the_person.mc_title]..."
        "She bites her lip and looks at the floor, avoiding your eye contact while she speaks softly."
        the_person.char "I don't want my punishment to end."
        mc.name "Sorry? I don't think I quite heard you."
        "[the_person.possessive_title] looks up at you, a sudden hunger in her eyes."
        the_person.char "I don't want you to stop fucking me! I like it, no, I love it!"
        the_person.char "When you just grab me and take me, like I'm just a fuck toy!"
        "She closes her eyes and moans."
        the_person.char "It makes me so wet, and I always cum so hard on your dick!"
        the_person.char "So don't stop my punishment, or I'll just have to keep breaking rules until you do this to me again."
        the_person.char "Please, [the_person.mc_title], can you keep punishing me?"
        menu:
            "Extend her punishment indefinitely":
                ...
                "She nods eagerly."
                the_person.char "I am, oh god I'm so happy [the_person.mc_title]!"
                the_person.char "Do you want to fuck, right now?"
                menu:
                    "Use her right now":
                        ...
                        the_person.char "Ah... Thank you [the_person.mc_title]!"
            ...
            "Refuse her request":
                ...
                the_person.char "Yes [the_person.mc_title], I'm sorry..."
