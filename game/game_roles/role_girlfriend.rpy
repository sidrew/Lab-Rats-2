...
label girlfriend_fuck_date_event(the_person):
    ...
    if the_person.get_opinion_score("not wearing anything") > the_person.get_opinion_score("lingerie"):
        ...
        $ the_person.apply_outfit(the_person.wardrobe.decide_on_outfit(the_person.sluttiness, 0), update_taboo = True) #She picks a slutty outfit, but nothing truly "special".
