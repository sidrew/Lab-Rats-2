...
label sister_instathot_label_mom(the_sister, the_mom):
    ...
    python: #TODO: generalise some of this and drip it into the group manager to make future scenes like this easy.
        removed_something = True #Start with this True so that the first loop is always executed.
        while removed_something:
            removed_something = False # We end once both girls fail to remove something
